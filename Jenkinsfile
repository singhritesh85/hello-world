    ...
    stages{
        ...
        stage("Build"){
            steps{
                ...
                sh 'scp -rv webapp docker-user@34.85.157.60:~/'
                sh 'scp -rv Dockerfile docker-user@34.85.157.60:~/'
                sh 'scp -rv docker-compose.yaml docker-user@34.85.157.60:~/'
            }
        }
        stage("Deployment"){
            steps{
                sh '''
                       ssh docker-user@34.85.157.60 << -EOT
